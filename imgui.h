...
namespace ImGui
{
	...
	IMGUI_API bool          ListBox(const char* label, int* current_item, bool (*items_getter)(void* data, int idx, const char** out_text), void* data, bool (*items_styler_begin)(void* data, int idx), void* items_styler_begin_data, bool (*items_styler_end)(void* data, int idx), void* items_styler_end_data, int items_count, int height_in_items = -1);
